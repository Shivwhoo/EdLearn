...
import { GraduationCap, ArrowRight, Sparkles, Volume2, ShieldCheck, Zap } from 'lucide-react';
...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      <main className="relative min-h-screen text-slate-100 flex flex-col justify-between overflow-x-hidden pt-24">
        ...
        <section className="max-w-6xl mx-auto px-6 pt-16 pb-20 text-center relative z-10 flex-1 flex flex-col justify-center items-center">
          ...
          <p
            className="text-2xl sm:text-3xl text-white/80 italic mb-3"
          ...
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight leading-tight max-w-4xl bg-gradient-to-b from-white to-slate-400 bg-clip-text text-transparent">
            Master Any Skill with Personalized,{' '}
        ...
        <section className="max-w-6xl mx-auto px-6 py-20 relative z-10 border-t border-slate-800/60 w-full">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            {/* Card 1 */}
            <div className="p-6 bg-slate-900/60 backdrop-blur-sm border border-slate-800/80 rounded-2xl space-y-4 hover:border-indigo-500/30 transition-all hover:scale-[1.01]">
        ...
        {/* Footer */}
        <footer className="border-t border-slate-900/80 py-8 bg-slate-950/60 backdrop-blur-sm z-10">
